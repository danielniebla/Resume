        ...
        <div className='p-4'>
            ...
            <div className='lifeLine py-4 items-center gap-4'>
                ...
                <Exp1 title='Cecsin a web for school' 
                    ...
                    textoUno='Construido para una escuela privada usando React y Nest.js, este sistema gestiona estudiantes, profesores y cursos, con inscripciones, pagos de matrícula, cierre de caja y operaciones CRUD. Me uní cuando el backend estaba hecho en un 70-80%, y el frontend en un 25-35%. Mi papel se centró en las pruebas y la integración de componentes para asegurar que todo funcionaba de forma coherente.'
                ...
                <Exp1 title='Universidad Autonoma de Sinaloa'
                    ...
                    textoUno='Participé en este proyecto como lider de equipo y responsable de front-end. Desarrollé todo el proyecto front-end utilizando Angular y también fui responsable de la mayor parte de la documentación.'
                    ...
                    textoDos='Se trataba de mi proyecto de servicio social, en el que el encargado actuaba como cliente, especificando los requisitos del proyecto. También pidió que la documentación se redactara como una tesis, animándonos a abordar el proyecto con el mismo rigor y profundidad.'
